...
|--------------|-----------------------------------------------------------------------|---------------------------------------------------------------------------|
| **Next.js**  | React framework umožňující server-side rendering a statické generování stránek. | Rychlé načítání stránek, SEO optimalizace a plynulý uživatelský zážitek. |
| **React**    | JavaScript knihovna pro vytváření uživatelských rozhraní.             | Interaktivní a responzivní uživatelské rozhraní.                          |
| **shadcn/ui**| Knihovna komponent pro React, poskytující moderní a přizpůsobitelné uživatelské rozhraní. | Moderní a flexibilní UI, které je snadno přizpůsobitelné a škálovatelné.  |
...
| Technologie  | Popis                                                               | Důvod použití                                                             |
|--------------|---------------------------------------------------------------------|---------------------------------------------------------------------------|
| **Storybook**| Open-source nástroj pro vývoj UI komponent v izolaci pro React, Vue a Angular. Umožňuje streamování UI vývoje, testování a dokumentace. | Vývoj a testování UI komponent v izolaci, zajištění konzistence a bezchybnosti uživatelského rozhraní. |

### Version Control
| Technologie | Popis                                                               | Důvod použití                                                             |
|-------------|---------------------------------------------------------------------|---------------------------------------------------------------------------|
| **GitHub**  | Platforma pro verzování a spolupráci, umožňující více vývojářům pracovat na projektech současně. | Verzování kódu a kolaborativní vývoj, zajištění integrity kódu a týmové koordinace. |
...
| **RESTful API**| API pro komunikaci mezi systémem DigiMedic EHR a externími systémy. | Standardizovaná komunikace mezi různými systémy.                          |
